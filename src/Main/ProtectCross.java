...
public class ProtectCross {
//	static HashMap<String, Integer> FFprotectCross=Main.FFprotectCross;
//	static HashMap<String, Integer> FSprotectCross=Main.FFprotectCross;
//	static HashMap<String, Integer> SSprotectCross=Main.FFprotectCross;

	public  void protectcross(Nodepair inputNodepair,Cycle cycle,ArrayList<Cycle> cyclelist,ArrayList<Node> inputprotect,ArrayList<Node> inputprotect2)
	{
				...
				//*************以上不变
					if(noprotect==0)//若没有冲突则输出节点对 环 与两条路径
					{
							...
							if(result1==1){
								...
								share1=PD.panduan(inputNodepair, inputprotect2,protectNodepair,protect2);
							}
							if(result2==1){
								PanDuan PD=new PanDuan();//第一在这里
								share2=PD.panduan(inputNodepair, inputprotect2,protectNodepair,protect1);
							}
							//先判断在输出
